...
public class WYREffectHandler {
    ...
    private static List<Class<? extends WYREffect>> TESTING_EFFECTS_TO_GET_FIRST = new ArrayList<>(List.of(FiveMillionSmackeroonies.class, FiveMillionSmackeroonies.class));
