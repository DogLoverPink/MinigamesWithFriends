...
public class WYREffectHandler {
    ...
    private static final List<Class<? extends WYREffect>> TESTING_EFFECTS_TO_GET_FIRST = new ArrayList<>(List.of(Sliding.class, AlwaysMineBlockBelow.class, RandomFishing.class, Schizophrenia.class));
